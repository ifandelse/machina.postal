...
(function (root, factory) {
    ...
    var bus = machina.bus = {
        ...
        wireUp: function (fsm) {
            ...
            var handlerChannel = (fsm.handlerNamespace ||
                                  fsm.namespace + this.config.handlerChannelSuffix),
                eventChannel = (fsm.eventNamespace ||
                                fsm.namespace + this.config.eventChannelSuffix);
            fsm._bus = {
